...
| | |
|---|---|
| Last run (local) | 2026-09-21 11:15:01 |
| Verdict | **PASS** |
| Consistency check | exit code 0 |
| Checks | 629 checks run, 0 problem(s) |
| Remote drift | 2 path(s) differ from origin/main |
| Detail log | `logs/report_audit/audit_2026-09-21_111501.log` (local, not committed) |

## Remote drift

2 path(s) differ from origin/main:

- `docs/audits/expert-ml/2026-09-21_10-08-25_JST.md`
