"""Development-only high-precision first-board breakout selector."""
...
THESIS = "A higher cutoff keeps only first-board breakout setups with the strongest visible breakout evidence."
THRESHOLD = 0.700000
